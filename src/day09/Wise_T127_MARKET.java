  ...
  6-sonunda fis yazdırsın
    */
    ...
    private static void fisYazdir() {
        ...
        if (odeme<toplam){
            System.out.println("Ödeme Yetersiz. Ödemeniz "+(toplam-odeme)+" ₺ kadar eksiktir. Bu fark borç olarak hesabınıza kaydedilmiştir");
        }else {
        ...
        String formattedDateTime = saat.format(formatter);
            ...
            if (urunKodu>=31 && urunKodu<=35){
                ...
                switch (urunKodu){
                    case 31:
                        urunAdi="Nutella";
                        urunFiyati=109;
                        System.out.println(urunMiktari+" adet "+urunAdi+"fiyatı: "+(urunMiktari*urunFiyati)+" ₺'dir");
                        break;
                    case 32:
                        urunAdi="Prinç";
                        urunFiyati=40;
            ...
            if (urunKodu >= 11 && urunKodu <= 15) {
                ...
                switch (urunKodu) {
                    case 11:
                        urunAdi = "Patates";
                        urunFiyati = 12;
                        System.out.println(urunMiktari + " kg " + urunAdi + " fiyatı:" + urunFiyati * urunMiktari + "₺'dir");
                        break;
                    case 12:
                        urunAdi = "Soğan";
                        urunFiyati = 12;
